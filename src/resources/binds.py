...
def json_binds_to_guild_binds(bind_list: list, category: VALID_BIND_TYPES = None, id_filter: str = None) -> list[GuildBind]:
    """Convert a bind from a dict/json representation to a GuildBind object.

...
async def save_components(message: hikari.Message):
        ...
        for component in action_row.components:
            if isinstance(component, hikari.SelectMenuComponent):
                ...
                for option in component.options:
                    new_select_menu = new_select_menu.add_option(option.label, option.value).add_to_menu()
